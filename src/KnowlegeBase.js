...
export default function CustomizedTreeView() {
    ...
    return (
        <div className="knowledgebase">
            ...
            >
                <a href={README1} target="_blank"><StyledTreeItem nodeId="0" label="0x001: README" /></a>
                <StyledTreeItem nodeId="1" label="0x100: Knowledge base">
                    <a href={'#'} target="_blank"><StyledTreeItem nodeId="2" label="0x110: Author's Thesis" /></a>
                    <StyledTreeItem nodeId="3" label="0x120: Basics of Assembly">
                        <StyledTreeItem nodeId="7" label="0x121: Assembly Syntax">
                            <a href={SyntaxATnT} target="_blank"><StyledTreeItem nodeId="11" label="0x1211: AT&T Syntax" /></a>
                            <a href={SyntaxIntel} target="_blank"><StyledTreeItem nodeId="12" label="0x1212: Intel Syntax" /></a>
                        </StyledTreeItem>
                        <a href={AssmInstructions} target="_blank"><StyledTreeItem nodeId="8" label="0x122: Assembly Instructions" /></a>
                        <a href={EgInlineAssm} target="_blank"><StyledTreeItem nodeId="9" label="0x123: Example Inline Assembly Program" /></a>
                    </StyledTreeItem>
                    <StyledTreeItem nodeId="4" label="0x130: Background Reading Articles">
                        <a href="http://phrack.org/issues/49/14.html" target="_blank"><StyledTreeItem nodeId="5" label="0x131: Smashing the Stack for Fun and Profit - Aleph One" /></a>
                        <a href="http://flint.cs.yale.edu/cs421/papers/x86-asm/asm.html" target="_blank"><StyledTreeItem nodeId="51" label="0x132: x86 Assembly Guide (Comprehensive)" /></a>
                        <a href="https://securitycafe.ro/2015/10/30/introduction-to-windows-shellcode-development-part1/" target="_blank"><StyledTreeItem nodeId="52" label="0x133: Windows Shellcode Development 1/3" /></a>
                        <a href="https://securitycafe.ro/2015/12/14/introduction-to-windows-shellcode-development-part-2/" target="_blank"><StyledTreeItem nodeId="53" label="0x134: Windows Shellcode Development 2/3" /></a>
                        <a href="https://securitycafe.ro/2016/02/15/introduction-to-windows-shellcode-development-part-3/" target="_blank"><StyledTreeItem nodeId="54" label="0x135: Windows Shellcode Development 3/3" /></a>
                    </StyledTreeItem>
                </StyledTreeItem>
                <StyledTreeItem nodeId="100" label="0x200: Programs">
                    <StyledTreeItem nodeId="105" label="0x210: By Author">
                        <a href={InlineAssm} target="_blank"><StyledTreeItem nodeId="106" label="0x211: Inline_Assembly.c" /></a>
                        <a href={SimpleProg} target="_blank"><StyledTreeItem nodeId="107" label="0x212: SimpleProg.c" /></a>
                        <a href={VulnerableProg} target="_blank"><StyledTreeItem nodeId="108" label="0x213: Vulnerable_Prog#1.c" /></a>
                        <a href={Shellcode_Basecode} target="_blank"><StyledTreeItem nodeId="109" label="0x214: Shellcode_Basecode.c" /></a>
                    </StyledTreeItem>
                    <StyledTreeItem nodeId="111" label="0x220: By Dr. Paul Evans">
                        <a href={Sender} target="_blank"><StyledTreeItem nodeId="112" label="0x221: Sender.c" /></a>
                        <a href={Receiver} target="_blank"><StyledTreeItem nodeId="113" label="0x222: Receiver.c" /></a>
                        <a href={Networked_Basecode} target="_blank"><StyledTreeItem nodeId="114" label="0x223: Networked_Basecode.c" /></a>
                    </StyledTreeItem>
                    <StyledTreeItem nodeId="115" label="0x230: By Steve Hanna">
                        <a href={arwin} target="_blank"><StyledTreeItem nodeId="116" label="0x231: Arwin.c" /></a>
                    </StyledTreeItem>
                </StyledTreeItem>
                <StyledTreeItem nodeId="200" label="0x300: Exploits">
                    <StyledTreeItem nodeId="211" label="0x310: Shellcode Exploits">
                        <StyledTreeItem nodeId="212" label="0x311: MessageBoxA">
                            <a href={ShellcodeExploit_MsgBox} target="_blank"><StyledTreeItem nodeId="213" label="0x3111: Shellcode Exploit" /></a>
                            <a href={Disas_MsgBox} target="_blank"><StyledTreeItem nodeId="214" label="0x3112: Disassembly" /></a>
                        ...
                        <StyledTreeItem nodeId="216" label="0x312: SwapMouseButton" >
                            <a href={ShellcodeExploit_Swap} target="_blank"><StyledTreeItem nodeId="217" label="0x3121: Shellcode Exploit" /></a>
                            <a href={Disas_Swap} target="_blank"><StyledTreeItem nodeId="218" label="0x3122: Dissassembly" /></a>
                        ...
                        <StyledTreeItem nodeId="220" label="0x313: Calc.exe">
                            <a href={ShellcodeExploit_Calc} target="_blank"><StyledTreeItem nodeId="221" label="0x3131: Shellcode Exploit" /></a>
                            <a href={Disas_Calc} target="_blank"><StyledTreeItem nodeId="222" label="0x3132: Disassembly" /></a>
                        ...
                        <StyledTreeItem nodeId="230" label="0x314: Notepad.exe">
                            <a href={ShellcodeExploit_Notepad} target="_blank"><StyledTreeItem nodeId="231" label="0x3141: Shellcode Exploit" /></a>
                            <a href={Disas_Notepad} target="_blank"><StyledTreeItem nodeId="232" label="0x3142: Disassembly" /></a>
                ...
                <StyledTreeItem nodeId="300" label="0x400: Useful External Tools">
                    <a href="https://defuse.ca/online-x86-assembler.htm" target="_blank"><StyledTreeItem nodeId="301" label="0x410: x86/x64 Assembler and Disassembler" /></a>
                    <a href="https://www.rapidtables.com/convert/number/hex-to-ascii.html" target="_blank"><StyledTreeItem nodeId="302" label="0x420: Hex to ASCII Text Converter" /></a>
                </StyledTreeItem>
            </TreeView>
            <br />
        </div>
