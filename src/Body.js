...
const Body = () => {
    ...
    return ( 
        <div className="body">
            ...
            <p>Seeing that this is a rather technical topic, some background knowledge is required. My recommendation would be to start by reading the <i><a href={Thesis} target="_blank" rel="noopener noreferrer"> Author's Thesis </a></i> as it provides a complete overview and is on its own enough to get you started.</p>
